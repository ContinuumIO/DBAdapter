...
import dbadapter.pyodbc as pyodbc
import sys, getopt
import random
import string
import datetime
...
def main(argv):
    ...
    try:
        ...
        if (trace):
            print("it seems your DBAdapter does not support tracing in pyodbc")

    try:
        pyodbc.enable_mem_guards(guards)
    except:
        if (trace):
            print("it seems your DBAdapter does not mem_guards in pyodbc")
