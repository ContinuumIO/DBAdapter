"""
unittests for DBAdapter/pyodbc: money type support
"""
...
class TestMoney(IOProPyodbcTest):
    def test_smallmoney_dictarray(self):
        ...
        # smallmoney maps to decimal in odbc (with 4 decimal digits). In DBAdapter/pyodbc
    ...
    def test_money_dictarray(self):
        ...
        # money maps to decimal. It contains 4 decimal digits. In DBAdapter/pyodbc decimal
